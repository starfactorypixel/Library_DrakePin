...
DrakePinD pin1({GPIO_NUM_3}, DrakePin::Output, DrakePin::High);
DrakePinD pin2({GPIO_NUM_4}, DrakePin::Output, DrakePin::High);
DrakePinD pin3({GPIO_NUM_5}, DrakePin::OutputOpenDrain, DrakePin::Low);
DrakePinD pin4({GPIO_NUM_6}, DrakePin::OutputOpenDrain, DrakePin::Low);
DrakePinA adc1({ADC1_CHANNEL_1}, 0);											
```
